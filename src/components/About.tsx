    ...
    <section id="about" className="relative py-20 md:py-32">
      <div className="w-full">
        ...
        >
          ...
          <div className="flex flex-col gap-6 md:gap-10 text-sm md:text-base lg:text-lg text-ayame-gray leading-[2.2] md:leading-loose font-sans font-light max-w-3xl md:tracking-wide mb-12 md:mb-16 break-words">
            {content.about.paragraphs.map((p, idx) => (
              <p key={idx}>{p[language]}</p>
            ))}
          </div>

          <div className="border-l-2 border-ayame-accent pl-4 md:pl-6 py-1 md:py-2 pb-4 md:pb-6 max-w-3xl">
